...
if __name__ == '__main__':
    ...
    parser.add_argument('--wiki_dir', type=str,default='/media/yueyulin/data_4t/data/wiki_en')
    parser.add_argument('--book_dir', type=str,default='/media/yueyulin/data_4t/data/bookcorpus')
    parser.add_argument('--output_dir', type=str,default='/media/yueyulin/data_4t/data/mae_dataset')
    ...
    concatenated_dataset = datasets.concatenate_datasets([wiki_dataset, book_dataset])
