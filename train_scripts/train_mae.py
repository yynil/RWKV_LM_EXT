...
if __name__ == '__main__':
    ...
    train_dataloader = DataLoader(dataset, batch_size=args.mirco_bsz, collate_fn=partial(mae_collator, max_seq_length=args.max_seq_length, encoder_mlm_probability=0.3))
