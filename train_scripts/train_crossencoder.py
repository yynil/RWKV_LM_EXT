...
from src.model_ext import RwkvEncoderForClassification
import torch
from data.json_data_process import load_and_tokenize_cross_encoder_ds
def create_arg_parser():
    ...
    parser.add_argument('--sep_id', type=int, default=151330, help='sep id')
...
if __name__ == '__main__':
    ...
    train_dataloader = load_and_tokenize_cross_encoder_ds(args.train_data, args.max_seq_length, args.emb_id,args.sep_id, args.pad_id, args.micro_bsz)
