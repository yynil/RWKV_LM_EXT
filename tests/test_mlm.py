...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_file",type=str,default='/media/yueyulin/data_4t/models/mlm/epoch_0_step_340000/epoch_0_step_400000/RWKV-x060-MLM-ctx4096.pth.pth')
